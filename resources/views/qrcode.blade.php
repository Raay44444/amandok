...
<div class="badansurat">
	<table style="border-bottom: 5px solid #000000" width="100%" >
		...
		<td class="tengah">
		  <h1>BADAN PENGAWASAN KEUANGAN DAN PEMBANGUNAN</h1>
			<h1>PERWAKILAN PROVINSI SUMATERA BARAT</h1>
            <p></p>
			<p style="font-size: 12px">Jalan By Pass, KM 14, Aie Pacah, Padang 25177</p>
			<p style="font-size: 12px">Telepon (0751) 462777, 462988, 462144, Faksimile (0751) 462145 </p>
            <p style="font-size: 12px"><a style="font-style: italic">Email</a>: <a href="">sumbar@bpkp.go.id</a>,<a style="font-style: italic"> Website: </a><a href="https://www.bpkp.go.id/sumbar">www.bpkp.go.id/sumbar</a> </p>
		</td>
		</tr>	
	</table>
    <table width="100%">
    ...
    <table style="text-align: center" width="100%">
        ...
        <td>
        <p>SURAT PENGANTAR</p>
        <p>Nomor TU.00/SP-{{ $data->nomorsp }}/PW03.1/2023</p>	
        </td>
        </tr>
    </table>
    ...
    <table width="100%">
        <tr>
            ...
            <td width="0%"></td>
            <td width="42%" high="27%">
            <p>Padang, {{ \Carbon\Carbon::parse($data->tglkirim)->locale('id')->translatedformat('j F Y') }} <br>
